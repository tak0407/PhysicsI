...
갈릴레이(포물선 운동)부터 아인슈타인(상대성·광전 효과), 슈뢰딩거(터널링)까지 18개 실험을 담고 있다.
...
카테고리: 운동과 힘 / 진동 / 파동과 소리 / 유체와 회전 / 열역학 / 우주 / 상대성 / 양자 / 자유 놀이.
...
무엇을 만들지는 **ROADMAP.md**가 원본이다. 작업 전에 거기서 다음 항목을 고르고,
완료하면 체크와 날짜를 남길 것. 이 문서(AGENTS.md)는 "어떻게"만 다룬다.
